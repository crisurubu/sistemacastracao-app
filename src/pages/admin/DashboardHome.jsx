    ...
    return (
        <div className="space-y-8 p-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-[#1e293b] border border-slate-800 p-8 rounded-[2.5rem]">
                    <h3 className="text-white font-black italic uppercase text-sm mb-6 flex items-center gap-2"><TrendingUp className="text-blue-500" size={18}/> Eficiência por Clínica</h3>
                    <div className="h-[300px] w-full"> 
                        <ResponsiveContainer>
